...
const ContadorExperiencia = () => {
    
    return ( 
        <div className="grid justify-between max-w-3xl grid-cols-2 gap-3 mx-auto my-8 mt-2 md:flex md:grid-cols-4 md:gap-6">
...
export default ContadorExperiencia;